...
dotnet ef migrations add v0.0.3 --project Atlas.Data.Tenant.Migrations --startup-project Atlas.Data.Tenant.Migrations --context AtlasTenantDbContext --output-dir Migrations
